...
class VideosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'title' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'youtube_id' => ['type' => 'unique', 'columns' => ['youtube_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created_at' => '2020-10-14 10:48:07',
                'updated_at' => '2020-10-14 10:48:07',
            ],
        ];
        parent::init();
    }
